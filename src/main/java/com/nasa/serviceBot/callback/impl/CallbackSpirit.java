...
@Component
public class CallbackSpirit extends AbstractCallback {

    private final MarsRoverPhotos marsRoverPhotos;
    private final KeyboardFactory keyboardFactory;

    @Autowired
    public CallbackSpirit(MainManager manager, MarsRoverPhotos marsRoverPhotos, KeyboardFactory keyboardFactory) {
